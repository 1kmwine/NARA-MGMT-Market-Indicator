...
환율·소비지출전망CSI·가처분소득·주류소비 4개 지표를 보여주는 대시보드예요(2026-09-14부터 nara-mgmt-exchange-rate 블록을 흡수해 탭으로 통합).
...
| 테이블 | 내용 |
|---|---|
| `indicator` | 지표 마스터 7건 (csi / income / alcohol / fx_usd / fx_eur / fx_usd_daily / fx_eur_daily) — 출처 기관·통계표코드·단위·주기 |
